                        ...
                        <div class="d-flex align-items-center">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <a href="{{route('siswa.create')}}" class="btn btn-primary btn-round btn-md text-white">
                            ...
                            <table id="multi-filter-select" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row->editor}}</td>
                                        <td>
                                            <a href="{{ route('siswa.edit', $row->id)}}" class="btn btn-warning btn-sm" style="width: 50px; margin-top:5px;"><i class="fas fa-edit"></i></a>
