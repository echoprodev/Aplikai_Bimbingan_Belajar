                ...
                <div class="card card-stats card-round">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Add Data Siswa <strong>Demo</strong></h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{route('siswa.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="text" name="jadwal_les">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="data_pertemuan" name="jumlah_pertemuan" readonly>
                            </div>
                            <div class="form-group">
                                <label for="pembayaran">Pembayaran</label>
                                <select name="" id="pilih_data">
                                    @foreach ($paket as $row)
                                    <option value="{{ $row->harga}}"> {{ $row->kategori }} - {{ $row->paket }} - {{ $row->kelas }}</option>
                                    @endforeach
                                </select>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="data_harga" name="pembayaran" readonly>
                                </div>
                            </div>
                            <div class="form-group">
