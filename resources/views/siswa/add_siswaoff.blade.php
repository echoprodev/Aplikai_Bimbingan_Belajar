        ...
        <div class="col-sm-6 col-md-12">
                <div class="card card-stats card-round">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="" id="siswa" class="form-control" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select name="" id="nama_tentor" class="form-control" autocomplete="off">
                                <option label="Cari Data Tentor"></option>
                                @foreach ($siswa as $data)
                                <option value="{{ $data->nama_tentor }}">( Nama: {{ $data->nama_siswa }} ) - ( Nama Tentor: {{ $data->nama_tentor }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-12">
                <div class="card card-stats card-round">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('siswa-off.store')}}">
                            @csrf
                            <div class="form-group">
                                <label for="">Nama Siswa</label>
                                <input type="text" class="form-control" id="nama" name="nama_siswa" autocomplete="off" readonly placeholder="Input Nama Lengkap">
                            </div>
                            <div class="form-group">
                                <label for="">Nama Tentor</label>
                                <input type="text" class="form-control" id="data_tentor" name="nama_tentor" readonly placeholder="Input Nama Lengkap">
                            </div>
                            <div class="form-group">
                                <label for="tgl_join">Tanggal Berhenti</label>
                                <input type="text" class="form-control tgl" name="tgl_off" placeholder="dd-mm-yyyy">
                            </div>
                            <div class="form-group">
                                <label for="status">Keterangan</label>
                                <input type="text" class="form-control" name="keterangan" placeholder="alasan berhenti">
...
<script>
    var data = document.getElementById("siswa");
...
<script>
    var data = document.getElementById("nama_tentor");
    data.onchange = function() {
        var nama = document.getElementById("data_tentor");
        nama.value = this.value;
    };
</script>
@endsection
