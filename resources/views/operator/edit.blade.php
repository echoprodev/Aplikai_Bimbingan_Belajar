                ...
                <div class="card card-stats card-round">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('operator.update', $operator->id)}}">
                            ...
                            <div class="row mb-3">
                                <label for="role" class="col-md-4 col-form-label text-md-end">Hak Akses</label>

                                <div class="col-md-6">
                                    <select name="role" id="" class="form-control">
                                        <option value="admin" {{$operator->role == 'admin' ? 'selected' : ''}}>
                                            Admin
                                        </option>
                                        <option value="development" {{$operator->role == 'development' ? 'selected' : ''}}>
                                            Development
                                        </option>
                                    </select>
                                </div>
