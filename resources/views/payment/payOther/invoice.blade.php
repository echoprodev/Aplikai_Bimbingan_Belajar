        ...
        <div class="row justify-content-center">
            <div class="col-sm-6 col-md-4">
                <div class="card card-stats card-round">
                    <div class="card-body">
                        <form method="post" action="{{route('invoice-Lainnya.update', $other->id)}}">
                            @csrf
                            @method('PUT')
                            ...
                            <table border="0">
                                ...
                                <tr>
                                    <td colspan="3" class="text-center h3">Bukti Pembayaran Lainnya</td>
                                </tr>
                                <tbody>
                                    <tr>
                                        <td colspan="3">====================================</td>
                                    ...
                                    <tr>
                                        <td>No. Transaksi</td>
                                        <td>:</td>
                                        <td>{{$other->kode_transaksi}}</td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Transaksi</td>
                                        <td>:</td>
                                        <td>{{$other->kategori_bayar}}</td>
                                    </tr>
                                    <tr>
                                        <td>Pemabayaran Bulan</td>
                                        <td>:</td>
                                        <td>{{$other->periode_bayar}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px;">Tanggal Pembayaran</td>
                                        <td>:</td>
                                        <td>{{$other->tanggal_bayar}}</td>
                                    </tr>
                                    <tr>
                                        <td>Nominal Pembayaran</td>
                                        <td>:</td>
                                        <td>{{$other->nominal_bayar}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">{{$other->created_at}}</td>
                                        <td>Admin</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
