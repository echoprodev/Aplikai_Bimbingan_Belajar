        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    ...
                    <h3 class="text-white mb-2"><a href="{{route('devhome')}}"><i class="fas fa-home"></i></a> -> Form Add Data Customer Day</h3>
                </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="card card-stats card-round">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Form Kualitas Pelayanan (Custemer)</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{route('Customer-Day.store')}}">
                            @csrf
                            <div class="form-group">
